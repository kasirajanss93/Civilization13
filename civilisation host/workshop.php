...
if (!$con)
  ...
  $result = mysql_query("SELECT * FROM workshop");
...
?>
  ...
  <table border="3" >
						<tr>
						<th style="padding-right:50px;"><b>cid</b></th>
						<th style="padding-right:50px;"><b>name</b></th>
						<th style="padding-right:50px;"><b>year</b></th>
						<th style="padding-right:50px;"><b>college</b></th>
						<th style="padding-right:50px;"><b>contact</b></th>
						<th style="padding-right:50px;"><b>Paid</b></th>
						</tr>
					<?php
